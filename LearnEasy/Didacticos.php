...
<head>
	<meta charset="utf-8">
	<title>Learn Easy - Didacticos</title>
...
<body id="Main" class="Main">
  ...
  <section class="Bib-publi">
    <?php 
    if (!isset($_GET['Filmat'])) {
      $query = "SELECT * FROM material_subido WHERE IDrecursos = 4";
    }
    if (isset($_GET['Filmat'])){
    $filtro = $_GET['Filmat'];
      $query = "SELECT * FROM material_subido WHERE IDrecursos = 4 AND IDmateria = '$filtro'";
    }
