...
<body id="Main" class="Main">
  <header class="L-head">
    ...
    <div class="bib" id="mate">
  	...
  	<form action="#" method="GET" style="margin-left: 30%;">
  		<input type="text" name="buscar" id="barra" placeholder="Buscar" style="width: 550px;">
  ...
  <section class="Bib-publi">
    <?php 
    $query = "SELECT * FROM material_subido WHERE IDmateria = 3 AND IDdocente > 0";
  ...
  <?php 
     ...
     switch ($rolus) {
       case 0:
         ...
         break;
      case 83:
           echo "<a href=''AgrMaterial.php?Materia=3'><button class='subir'></button></a>";
         break;
        case 2:
