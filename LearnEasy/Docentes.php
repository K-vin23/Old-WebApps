...
<head>
	<meta charset="utf-8">
	<title>Learn Easy - Docentes</title>
...
<body id="Main" class="Main">
  ...
  <?php 
  $query = "SELECT do.nomb_docente, us.Img, us.IDusuario
          FROM `docente` AS do
          INNER JOIN usuarios AS us ON do.IDusuario = us.IDusuario WHERE do.IDdocente > 0";
  ...
  <div class="Est" style="margin-left: 4%;">
    ...
    <a href="ElimDoc.php?IDelim=<?php echo $row[2]; ?>"><button>Eliminar</button></a>
    <a href="EditDoc.php?IDedit=<?php echo $row[2]; ?>"><button>Editar</button></a>
  </div>
<?php } ?>
</section>
