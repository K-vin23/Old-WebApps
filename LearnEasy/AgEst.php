...
<body>
	...
	<center>
	<form action="AgrEstudiante.php" method="POST" class="Login" id="registro">
		...
		<input type="number" name="ID" placeholder="ID Usuario" class="F-Label" required>
		<label class="L-Log">Grado:</label>
		<input type="int" name="Gr" placeholder="Grado" class="F-Label" required><br>
		<br>
