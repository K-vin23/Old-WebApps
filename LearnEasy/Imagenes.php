...
<head>
	<meta charset="utf-8">
	<title>Learn Easy - Imagenes</title>
...
<body id="Main" class="Main">
  ...
  <section class="Bib-publi">
    <?php 
     if (!isset($_GET['Filmat'])) {
      $query = "SELECT * FROM material_subido WHERE IDrecursos = 5";
    }
    if (isset($_GET['Filmat'])){
    $filtro = $_GET['Filmat'];
      $query = "SELECT * FROM material_subido WHERE IDrecursos = 5 AND IDmateria = '$filtro'";
    }
